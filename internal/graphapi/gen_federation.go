...
func (ec *executionContext) __resolve_entities(ctx context.Context, representations []map[string]interface{}) []fedruntime.Entity {
	...
	resolveEntity := func(ctx context.Context, typeName string, rep map[string]interface{}, idx []int, i int) (err error) {
		...
		switch typeName {
		case "Example":
			resolverName, err := entityResolverNameForExample(ctx, rep)
			if err != nil {
				return fmt.Errorf(`finding resolver for Entity "Example": %w`, err)
			}
			switch resolverName {
			...
			case "findExampleByID":
				...
				if err != nil {
					return fmt.Errorf(`unmarshalling param 0 for findExampleByID(): %w`, err)
				}
				entity, err := ec.resolvers.Entity().FindExampleByID(ctx, id0)
				if err != nil {
					return fmt.Errorf(`resolving Entity "Example": %w`, err)
				}
...
func entityResolverNameForExample(ctx context.Context, rep map[string]interface{}) (string, error) {
	for {
		var (
		...
		return "findExampleByID", nil
	}
	return "", fmt.Errorf("%w for Example", ErrTypeNotFound)
}
