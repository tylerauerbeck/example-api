...
func (eq *ExampleQuery) FirstID(ctx context.Context) (id gidx.PrefixedID, err error) {
...
func (eq *ExampleQuery) FirstIDX(ctx context.Context) gidx.PrefixedID {
...
func (eq *ExampleQuery) OnlyID(ctx context.Context) (id gidx.PrefixedID, err error) {
	var ids []gidx.PrefixedID
...
func (eq *ExampleQuery) OnlyIDX(ctx context.Context) gidx.PrefixedID {
...
func (eq *ExampleQuery) IDs(ctx context.Context) (ids []gidx.PrefixedID, err error) {
...
func (eq *ExampleQuery) IDsX(ctx context.Context) []gidx.PrefixedID {
	ids, err := eq.IDs(ctx)
	if err != nil {
		panic(err)
	}
