...
func (tc *TodoCreate) SetTenantID(gi gidx.PrefixedID) *TodoCreate {
	tc.mutation.SetTenantID(gi)
	return tc
}

// SetID sets the "id" field.
func (tc *TodoCreate) SetID(gi gidx.PrefixedID) *TodoCreate {
	tc.mutation.SetID(gi)
	return tc
}

// SetNillableID sets the "id" field if the given value is not nil.
func (tc *TodoCreate) SetNillableID(gi *gidx.PrefixedID) *TodoCreate {
	if gi != nil {
		tc.SetID(*gi)
	}
	return tc
