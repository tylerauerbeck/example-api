...
func (tq *TodoQuery) FirstID(ctx context.Context) (id gidx.PrefixedID, err error) {
...
func (tq *TodoQuery) FirstIDX(ctx context.Context) gidx.PrefixedID {
...
func (tq *TodoQuery) OnlyID(ctx context.Context) (id gidx.PrefixedID, err error) {
	var ids []gidx.PrefixedID
...
func (tq *TodoQuery) OnlyIDX(ctx context.Context) gidx.PrefixedID {
...
func (tq *TodoQuery) IDs(ctx context.Context) (ids []gidx.PrefixedID, err error) {
...
func (tq *TodoQuery) IDsX(ctx context.Context) []gidx.PrefixedID {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
