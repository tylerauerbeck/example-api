...
func withTodoID(id gidx.PrefixedID) todoOption {
...
func (m *TodoMutation) SetID(id gidx.PrefixedID) {
	m.id = &id
}

// ID returns the ID value in the mutation. Note that the ID is only available
// if it was provided to the builder or after it was returned from the database.
func (m *TodoMutation) ID() (id gidx.PrefixedID, exists bool) {
	if m.id == nil {
		return
	}
	return *m.id, true
...
func (m *TodoMutation) IDs(ctx context.Context) ([]gidx.PrefixedID, error) {
	switch {
...
func (m *TodoMutation) SetTenantID(gi gidx.PrefixedID) {
	m.tenant_id = &gi
}

// TenantID returns the value of the "tenant_id" field in the mutation.
func (m *TodoMutation) TenantID() (r gidx.PrefixedID, exists bool) {
	v := m.tenant_id
	if v == nil {
		return
	}
...
// If the Todo object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *TodoMutation) OldTenantID(ctx context.Context) (v gidx.PrefixedID, err error) {
	if !m.op.Is(OpUpdateOne) {
